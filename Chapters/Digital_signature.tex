...
\begin{itemize}
	...
	\end{itemize}
\item When only one element remains, with very large probability it will be of the form $(1, K)$, otherwise it will be of the form $(a, K)$: the output is $K$ or $aK$, respectively.
\end{itemize}
...
\begin{figure}
	\makebox[\textwidth]{\includegraphics[scale=0.7]{Images/speedup.eps}}
